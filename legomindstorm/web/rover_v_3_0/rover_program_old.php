...
<option value="set_speed">set motor X speed Y
<option value="wait">wait for Y ms
<option value="set_var">set var X is Y
<option value="Y_g_X">When Y greater than X then Z
<option value="Y_s_X">When Y smaller than X then Z
<option value="Y_e_X">When Y same as X then Z
<option value="Y_ne_X">When Y not same as X then Z
</select><br />
X: <select name="X">
