...
<head> 
  ...
  <script type="text/javascript" language="javascript" src="template/default/script/menu.js"></script> 
  <script type="text/javascript" language="javascript" src="template/default/script/ajax.js"></script> 
  <script type="text/javascript" language="javascript" src="script.js"></script>
</head> 
<body onload="initButtons();watch_page();check_url();who_is_online();"> 
 
  <div id="heading"> 
    <a href="http://www.teamfrednet.org/" > 
    <img alt="teamFREDNET logo" src="img/teamfred_simple_logo.png" class="head_logo" /> 
    </a> 
    teamFREDNET MindStorm Lunar Rover Portal
  </div> 
 ...
 <div id="logbook"><!-- testing -->
 </div>
  <div id="right_col"> 
    <div class="rankBox"> 
      <h4 style="padding:0; margin:0;">My Ranking</h4> 
      <ul style="list-style-type:none; background-color: #BC99FF; padding:0; font-size:10pt"> 
    ...
    <div class="rankBox"> 
      ...
      <img alt="World Map" title="World Map" id="RegionMap"
           ...
           style="width: 100%;" src="img/regional_map.gif"/> 
  ...
  <div id="footer"> 
    <table class="footTabs"> 
      <tr> 
        <td class="footer"> 
          <a class="hilite2" onclick="update_url('static_about');">About</a> 
        </td> 
        <td class="footer"> 
          <a class="hilite2" onclick="update_url('static_faq');">FAQ</a> 
        </td> 
        <td class="footer"> 
          <a class="hilite2" onclick="update_url('static_press_inquiries');">Press Inquiries</a> 
        </td> 
        <td class="footer"> 
          <a class="hilite2" onclick="update_url('static_contact');">Contact</a> 
        </td> 
        <td class="footer"> 
        ...
        <td class="footer">         
            <a href="http://jigsaw.w3.org/css-validator/check/referer"> 
              <img style="border:0;height:20px"
