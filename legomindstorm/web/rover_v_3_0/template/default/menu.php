...
?>
	<div class="navButton" id="button_<?php echo $upper; ?>" style="top: 80px;" onclick="revealMenu(<?php echo $upper; ?>);">
	<?php echo $name_upper; ?>
		<div class="navSubMenu" id="menu_<?php echo $upper; ?>" style="visibility: hidden;"> 
			<ul class="Menu"> 
<?php
$lower = 1;
...
?>
			<li> 
				<a class="hilite" onclick="update_url('<?php echo $namespace_lower; ?>');" ><?php echo $name_lower; ?></a> 
			</li> 
<?php
$lower++;
}
