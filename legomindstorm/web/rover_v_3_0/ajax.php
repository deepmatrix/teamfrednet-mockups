...
?>
 <div id="mainPlayer" >
       <object width="425" height="344" id="mainPlayer" style="margin-left: 1em;"> 
        <param name="movie" value="http://www.youtube.com/v/<?php echo $_GET['clip']; ?>&hl=en&fs=1&"></param> 
        <param name="allowFullScreen" value="true"></param> 
        <param name="allowscriptaccess" value="always"></param> 
        <param name="autoplay" value="true"></param> 
        <embed name="mainPlayer" src="http://www.youtube.com/v/<?php echo $_GET['clip']; ?>&hl=en&fs=1&" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="425" height="344"></embed> 
      </object> 
<?php
}
